 ...
 *
 * Shows the pi ASCII logo in forced green + app name + version.
 */
function buildHeader(theme: Theme): string {
	// ── Logo ──────────────────────────────────────────────
	// Vert forcé en ANSI direct (`\x1b[1;32m` = bold + green) : les couleurs
	// sémantiques du thème ("success", etc.) dépendent du thème actif et le
	// rendaient jaune. L'ANSI brut est garanti vert quel que soit le thème.
